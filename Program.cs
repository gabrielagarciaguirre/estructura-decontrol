...
namespace Estructurasdecontrol
{
    ...
    class Program
    {
        ...
        static void menu()
        {
            ...
            System.Console.WriteLine("Ingrese el numero 1 para mostrar el menú o el numero 3 para salir.");
        ...
        static void ejemplo_if()
        {
            ...
            Console.WriteLine("Ingrese un numero entre 2 y 4:");
